...
#SBATCH --job-name=del-pg-0.5    # sets the job name if not set from environment
...
mpirun -n 1 python run_pg.py --hash_type pghash --steps_per_test 100 --train_bs 128 --dataset Delicious200K --cr 0.5 --name pg --randomSeed 1203 --num_tables 50