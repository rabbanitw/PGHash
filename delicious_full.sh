...
#SBATCH --job-name=full    # sets the job name if not set from environment
...
mpirun -n 1 python run_pg.py --hash_type pg_avg --steps_per_test 100 --train_bs 128 --dataset Delicious200K --cr 1 --name full-network
