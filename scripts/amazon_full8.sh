...
#SBATCH --job-name=amz_f8_1    # sets the job name if not set from environment
...
mpirun -n 8 python run_pg.py --hash_type regular --epochs 20 --steps_per_test 250 --train_bs 256 --sdim 8 --dataset Amazon670K --cr 1 --name test1 --randomSeed 1203
