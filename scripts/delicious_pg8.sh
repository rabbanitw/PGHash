...
#SBATCH --job-name=pg_d8_1    # sets the job name if not set from environment
...
mpirun -n 8 python run_pg.py --hash_type pghash --steps_per_test 100 --train_bs 128 --dataset Delicious200K --epochs 30 --name test1 --randomSeed 1203
