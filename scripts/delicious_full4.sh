...
#SBATCH --job-name=del4_f    # sets the job name if not set from environment
...
mpirun -n 4 python run_pg.py --hash_type regular --steps_per_test 100 --train_bs 128 --dataset Delicious200K --cr 1 --name test1 --randomSeed 1203
