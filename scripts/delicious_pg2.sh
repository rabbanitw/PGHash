...
#SBATCH --job-name=pg_d2_1    # sets the job name if not set from environment
...
mpirun -n 2 python run_pg.py --hash_type pghash --steps_per_test 100 --train_bs 128 --dataset Delicious200K --epochs 8 --cr 0.1 --name test1 --randomSeed 1203
