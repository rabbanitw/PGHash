...
mpirun -n 1 python run_pg.py --hash_type pghash --steps_per_test 500 --train_bs 256 --dataset Amazon670K --cr 0.25 --q 1 --name exp-t1-class --randomSeed 1203