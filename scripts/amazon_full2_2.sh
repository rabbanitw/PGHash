...
#SBATCH --job-name=amz_f2_2    # sets the job name if not set from environment
...
mpirun -n 2 python run_pg.py --hash_type regular --steps_per_test 500 --train_bs 256 --sdim 8 --dataset Amazon670K --cr 1 --name test2 --randomSeed 346
