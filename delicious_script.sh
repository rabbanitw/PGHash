...
mpirun -np 1 python run_cluster.py --mca btl_openib_warn_no_device_params_found 0 --mca orte_base_help_aggregate 0 --mca btl ^openib ... --dataset Delicious200K --cr 1 --no-lsh --epochs 10 --batch_size 256
