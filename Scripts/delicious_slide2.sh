...
#SBATCH --job-name=del_sli2    # sets the job name if not set from environment
...
mpirun -n 1 python run_pg.py --hash_type slide --steps_per_test 100 --train_bs 128 --dataset Delicious200K --name test2 --randomSeed 346
