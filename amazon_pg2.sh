...
#SBATCH --job-name=pg_amz2_1    # sets the job name if not set from environment
...
mpirun -n 2 python run_pg.py --hash_type pghash --steps_per_test 500 --train_bs 256 --sdim 8 --dataset Amazon670K --epochs 10 --cr 0.1 --name test1 --randomSeed 1203
