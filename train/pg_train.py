...
def pg_train(rank, Method, optimizer, train_data, test_data, losses, train_acc_metric, test_acc_metric, recorder, args):
    """
    ...
    comm_time = 0
    comm_time1 = 0
    smartavg = True  # this just ensures weights are only averaged with others that have been updated
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for (x, y) in train_data:
            ...
            with tf.GradientTape() as tape:
                ...
                # stop gradient to non-active neurons (unsure if this is necessary)
