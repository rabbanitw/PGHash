...
#SBATCH --job-name=pg_d1_2    # sets the job name if not set from environment
...
mpirun -n 1 python run_pg.py --hash_type pghash --steps_per_test 100 --train_bs 128 --dataset Delicious200K --cr 0.1 --name test2 --randomSeed 346
