...
mpirun -n 4 python run_pg.py --hash_type slide --dwta 1 --steps_per_test 100 --train_bs 256 --dataset Amazon670K --cr 1 --epochs 40 --name slide --randomSeed 1203 --c 8 --sdim 8 --num_tables 50 --steps_per_lsh 50