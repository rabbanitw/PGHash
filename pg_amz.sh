...
mpirun -n 1 python run_pg.py --hash_type pghash --dwta 1 --steps_per_test 100 --train_bs 256 --dataset Amazon670K --cr 1 --epochs 10 --name run2 --randomSeed 239 --c 8 --sdim 8 --num_tables 50 --steps_per_lsh 50