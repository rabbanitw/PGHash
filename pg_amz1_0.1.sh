...
mpirun -n 1 python run_pg.py --hash_type pghash --steps_per_test 500 --train_bs 128 --sdim 6 --dataset Amazon670K --cr 0.1 --q 1 --name exp-t1 --randomSeed 1203