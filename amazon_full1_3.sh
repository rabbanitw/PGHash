...
#SBATCH --job-name=amz_f1_3    # sets the job name if not set from environment
...
mpirun -n 1 python run_pg.py --hash_type regular --steps_per_test 500 --train_bs 256 --sdim 8 --dataset Amazon670K --cr 1 --name test3 --randomSeed 5425
