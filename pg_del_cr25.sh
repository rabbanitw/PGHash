...
mpirun -n 1 python run_pg.py --hash_type pghash --steps_per_test 100 --train_bs 128 --dataset Delicious200K --cr 0.25 --c 8 --sdim 8 --name run2 --randomSeed 239 --num_tables 50 --steps_per_lsh 1 --epochs 7 --dwta 0