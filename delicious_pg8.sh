...
#SBATCH --job-name=pg_d8    # sets the job name if not set from environment
...
mpirun -n 8 python run_pg.py --hash_type pg_avg --steps_per_test 100 --train_bs 128 --dataset Delicious200K --name pghash
