...
mpirun -n 1 python run_pg.py --hash_type slide --steps_per_test 100 --train_bs 256 --dataset Wiki325K --cr 1 --name run1 --randomSeed 1203 --test_bs 8192 --num_tables 50 --steps_per_lsh 50 --c 5 --dwta 1